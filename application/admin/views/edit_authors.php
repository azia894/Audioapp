<div class="content-page">
	...
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="page-title">Edit Author - <?= $record['aut_name'] ?></h4>
					<ol class="breadcrumb">
						<li>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input class="form-control" id="aut_name" name="aut_name" value="<?= $record['aut_name'] ?>" maxlength="50">
									</div>
									<div class="form-group">
									...
									<div class="form-group row">
										<div class="col-md-6">
											<label>Image</label>
											<input type="hidden" name="aut_img" id="aut_img" value="<?= $record['aut_img'] ?>">
											<input type="file" name="upload_aut_img" id="upload_aut_img" accept="Image/png,image/jpeg" value="<?= $record['aut_img'] ?>">
										</div>
										<div class="col-md-6" style="padding-top: 18px; padding-left: 30px">
											<button type="button" class="btn btn-primary" disabled id="uploadBtn" onClick="new_author()">Upload image</button>
										</div>
									</div>
									<div class="row">
	...
	<script>
		...
		function new_author() {
			...
			console.log("founddd", document.getElementById('upload_aut_img'));
		...
		document.getElementById("upload_aut_img").addEventListener('change', function(event) {
			...
			if (target.files && file) {
				var reader = new FileReader();
				console.log("rreaaaaaaaaaaa",reader);
