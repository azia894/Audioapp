                 ...
                 <div id="postList">
                    ...
                    <div class="loading" style="display: none;"><div class="content"><img src="<?php echo base_url().'assets/images/loadingimage.gif'; ?>"/></div></div>
                        ...
                        <li class="catalog-result">
                            ...
                            <div class="result-data"><h3><a href="<?= base_url('authors/view/'.$post['id']) ?> "><?php echo ucwords($post['aut_name']); ?></a></h3><p class="book-author"> 
                            <span class="dod-dob">(<?php echo $post['dob']; ?>)</span></p>
                            <p class="book-meta">Complete | English</p><span><?php echo $post['total']; ?> books</span></div></li>
