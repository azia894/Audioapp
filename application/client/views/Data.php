	...
	?>
		...
		<li class="catalog-result">
			...
			<div class="result-data">
				<h3><a href="<?= base_url('chapter/view/' . $row['bkid']) ?> "><?php echo ucwords($row['bk_name']); ?></a></h3>
				<p class="book-author">
					<a href="<?= base_url('authors/view/' . $row['id']) ?>"><?php echo ucwords($row['aut_name']); ?><span class="dod-dob">(<?php echo $row['dob']; ?>)</span></a>
				</p>
