...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 17, 2021 at 09:04 AM
...
INSERT INTO `aud_author` (`id`, `aut_name`, `aut_desc`, `aut_img`, `created_on`, `aut_status`) VALUES
(1, 'Felix Weingartner', '<p>Paul Felix Weingartner, Edler von M&uuml;nzberg (2 June 1863 &ndash; 7 May 1942) was an Austrian conductor, composer and pianist.</p>', '1615836933.jpeg', '2021-03-15 20:35:33', 1),
(2, 'Apj Abdul Kalam', '<p>He played an important role in the second Pokhran nuclear test in 1998. He was also associated with India\'s space program and missile development program. Therefore, he is also called \"Missile Man\".</p>', '1615919478.jpg', '2021-03-16 19:31:18', 1);
...
INSERT INTO `aud_booktbl` (`id`, `author_id`, `sub_id`, `bk_name`, `bk_desc`, `bk_img`, `created_on`, `bk_status`) VALUES
...
(2, 0, 1, 'chapter 2', '1615965803.mp3', '2021-03-17 08:23:23', 1),
