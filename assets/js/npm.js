              ...
              value: function init() {
                ...
                $(this._element)
                  ...
                  .on(Event.CLICK_DATA_API, function(e) {
                    ...
                    var _siblings = _parent.siblings("li").children("a.t"); // edit custom .t
                    ...
                    if (
                      _parent.hasClass(self._config.activeClass) &&
                      !self._config.doubleTapToGo
                    ) {
                ...
                if (this._config.toggle) {
                  this._hide(
                    _el
                      .parent("li")
                      .siblings()
                      .children("ul." + this._config.collapseInClass)
                      .attr("aria-expanded", false)
                  );
                }
